...
- **2026-08-02**:
  ...
  - **【構築完了】SQL Server 2025 Standard Developer Edition 導入成功 & 接続設計確定**:
    ...
    3. **自PC用接続**: `Server=localhost;Database=RouteXWmsDb;Trusted_Connection=True;`（高速・確実なローカルアクセス）
    4. **他PC(外部端末)用接続**: `Server=192.168.40.7;Database=RouteXWmsDb;User Id=routex_user;Password=RouteX1234!;TrustServerCertificate=True;MultipleActiveResultSets=true;`（LAN経由の1433ポートアクセス）
